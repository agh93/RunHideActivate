...
def publish_message(msg):
    ...
    if (msg == "Detected"):
        data = {"To": "Server", "From": "Dist1", "Msg_Type": "Detection", "Msg": "now"}
    elif (msg == "No Detected"):
        data = {"To": "Server", "From": "Dist1", "Msg_Type": "Detection", "Msg": "prev"}
    elif (msg_type == "Device"):
        data = {"To": "Server", "From": "Dist1", "Msg_Type": "Activation", "Msg": msg}
    else:
        data = {"To": "Server", "From": "Dist1", "Msg_Type": "Logs", "Msg": msg}
